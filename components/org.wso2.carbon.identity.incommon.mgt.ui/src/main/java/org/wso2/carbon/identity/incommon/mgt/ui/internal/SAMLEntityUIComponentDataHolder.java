...
public class SAMLEntityUIComponentDataHolder {

    private static SAMLEntityUIComponentDataHolder instance = new SAMLEntityUIComponentDataHolder();
    private DataSource dataSource;
    private InCommonMetadataManagementService inCommonMetadataManagementService;

    private SAMLEntityUIComponentDataHolder() {
    }

    public static SAMLEntityUIComponentDataHolder getInstance() {
        return instance;
    }
